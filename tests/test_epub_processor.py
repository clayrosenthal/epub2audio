...
from src.epub_processor import EPUBProcessor, Chapter, BookMetadata
...
def sample_epub(tmp_path):
    ...
    # Add chapters
    c1 = epub.EpubHtml(title='Chapter 1', file_name='chap_1.xhtml', content='''
        <h1>Chapter 1</h1>
        <p>This is the first chapter.</p>
    ''')
    c2 = epub.EpubHtml(title='Chapter 2', file_name='chap_2.xhtml', content='''
        <h1>Chapter 2</h1>
